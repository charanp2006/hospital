              ...
              dashboardData.latestAppointments.map((appointment,index) => (
                <div key={index} className='flex items-center px-6 py-3 gap-3 hover:bg-gray-100'>
                  ...
                  <div className='flex-1 text-sm'>
                    ...
                    ? <p className='text-red-500 font-sm cursor-not-allowed'>Cancelled</p>
                    : <p onClick={()=>cancelAppointment(appointment._id)} className='text-blue-500 font-sm cursor-pointer'>Cancel</p>
                    }
                </div>
              ))
            )
