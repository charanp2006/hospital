    ...
    <div className='min-h-screen bg-white border-r border-gray-200'>
...

      {
        dToken && <ul className='text-[#515151] mt-5 '>
            ...
            <NavLink className={({isActive}) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:win-w-72 cursor-pointer ${isActive? 'bg-[#f2f3ff] border-r-4 border-primary':''}`} to={"/doctor-dashboard"}>
                <img src={assets.home_icon} alt="" />
                <p className='hidden md:block'>Dashboard</p>
            </NavLink>
            <NavLink className={({isActive}) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:win-w-72 cursor-pointer ${isActive? 'bg-[#f2f3ff] border-r-4 border-primary':''}`} to="/doctor-appointments">
                <img src={assets.appointment_icon} alt="" />
                <p className='hidden md:block '>Appointments</p>
            </NavLink>
            <NavLink className={({isActive}) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:win-w-72 cursor-pointer ${isActive? 'bg-[#f2f3ff] border-r-4 border-primary':''}`} to="/doctor-profile">
                <img src={assets.add_icon} alt="" />
